...
<form action="/board/<?=$id?>/modify/registerModify/<?= $page ?>/<?= $seq ?>" name="write" id="write-form" method="POST" enctype="multipart/form-data">
    <div class="input-group mb-3">
        <span class="input-group-text">제목</span>
        <input type="text" class="form-control" id="write-title" name="write-title" placeholder="제목을 입력하세요." value="<?= $modify->bc_title ?>" autocomplete="off">
    </div>
